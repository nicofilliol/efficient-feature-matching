...
def main():
    ...
    helper.plot_weight_distribution(sample_param_sets_dense, out_path="weights_superglue_dense.png")
    helper.plot_weight_distribution(sample_param_sets_pruned, out_path="weights_superglue_finetuned.png", count_nonzero_only=True)
